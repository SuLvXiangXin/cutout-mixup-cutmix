# python train.py --method baseline --dataset cifar10 --model resnet18 --epochs 10
# python train.py --method baseline --dataset cifar100 --model resnet18 --epochs 10
# python train.py --method baseline --dataset cifar10 --model resnet18 --data_augmentation --epochs 10
# python train.py --method baseline --dataset cifar100 --model resnet18 --data_augmentation --epochs 10
# python train.py --method cutout --dataset cifar10 --model resnet18 --data_augmentation --epochs 10
# python train.py --method cutout --dataset cifar100 --model resnet18 --data_augmentation --epochs 10
# python train.py --method mixup --dataset cifar10 --model resnet18 --data_augmentation --epochs 10
# python train.py --method mixup --dataset cifar100 --model resnet18 --data_augmentation --epochs 10
# python train.py --method cutmix --dataset cifar10 --model resnet18 --data_augmentation --epochs 10
# python train.py --method cutmix --dataset cifar100 --model resnet18 --data_augmentation --epochs 10  --cutmix_prob 0.1
